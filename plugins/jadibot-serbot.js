...
- JoseXrl15k >> https://github.com/JoseXrl15k 
*/
...
const { state, saveState, saveCreds } = await useMultiFileAuthState(pathnakanoJadiBot)
...
userJid = sock.authState.creds.me.jid || `${path.basename(pathnakanoJadiBot)}@s.whatsapp.net`
